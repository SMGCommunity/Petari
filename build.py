...
flags = "-nodefaults -proc gekko -DRELEASE -Cpp_exceptions off -O4,s -fp hard -enum int -sdata 4 -sdata2 4 -lang=c99 -align powerpc -inline auto -pragma \"always_inline on\" -DEPPC -DHOLLYWOOD_REV -DTRK_INTEGRATION -DGEKKO -DMTX_USE_PS -MMD -rtti off "
