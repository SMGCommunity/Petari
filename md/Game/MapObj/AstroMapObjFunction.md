# main/Game/MapObj/AstroMapObjFunction
...
| Name | Address | Match % |
|------|---------|---------|
| `getNumGrandStarForRevival__33@unnamed@AstroMapObjFunction_cpp@FPCcl` | `0x801AFF88` | :white_check_mark: (100.0%) |
| `getNumGrandStarForOpen__33@unnamed@AstroMapObjFunction_cpp@FPCcl` | `0x801B0204` | :white_check_mark: (100.0%) |
| `makeArchiveListFromArg0__19AstroMapObjFunctionFP27NameObjArchiveListCollectorRC12JMapInfoIter` | `0x801B0218` | :x: (99.9%) |
...
| `getModelName__19AstroMapObjFunctionFPCcl` | `0x801B0504` | :white_check_mark: (100.0%) |
| `createAstroNamePlateParser__19AstroMapObjFunctionFv` | `0x801B05C8` | :x: (90.0%) |
