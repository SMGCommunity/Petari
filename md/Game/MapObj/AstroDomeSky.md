# main/Game/MapObj/AstroDomeSky

**Source Path:** `src/Game/MapObj/AstroDomeSky.cpp`

## Functions

| Name | Address | Match % |
|------|---------|---------|
| `__ct__12AstroDomeSkyFPCc` | `0x801AE3F8` | :white_check_mark: (100.0%) |
| `init__12AstroDomeSkyFRC12JMapInfoIter` | `0x801AE458` | :x: (100.0%) |
| `draw__12AstroDomeSkyCFv` | `0x801AE57C` | :white_check_mark: (100.0%) |
| `calcAndSetBaseMtx__12AstroDomeSkyFv` | `0x801AE584` | :x: (0.0%) |
| `receiveOtherMsg__12AstroDomeSkyFUlP9HitSensorP9HitSensor` | `0x801AE634` | :white_check_mark: (100.0%) |
| `tryRotateAppearance__12AstroDomeSkyFv` | `0x801AE6B4` | :x: (0.0%) |
| `exeHide__12AstroDomeSkyFv` | `0x801AE7B8` | :x: (74.9%) |
| `exeAppear__12AstroDomeSkyFv` | `0x801AE868` | :x: (0.0%) |
| `exeWait__12AstroDomeSkyFv` | `0x801AE980` | :x: (0.0%) |
| `exeRotateAppear__12AstroDomeSkyFv` | `0x801AE9E8` | :white_check_mark: (100.0%) |
| `exeRotateDisappear__12AstroDomeSkyFv` | `0x801AEA5C` | :white_check_mark: (100.0%) |
