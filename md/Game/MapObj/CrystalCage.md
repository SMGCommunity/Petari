...
| Name | Address | Match % |
|------|---------|---------|
| `__ct__11CrystalCageFPCc` | `0x801CB150` | :white_check_mark: (100.0%) |
| `init__11CrystalCageFRC12JMapInfoIter` | `0x801CB21C` | :white_check_mark: (100.0%) |
| `initAfterPlacement__11CrystalCageFv` | `0x801CB5FC` | :white_check_mark: (100.0%) |
| `kill__11CrystalCageFv` | `0x801CB72C` | :white_check_mark: (100.0%) |
| `forceBreak__11CrystalCageFv` | `0x801CB788` | :white_check_mark: (100.0%) |
...
| `initMapToolInfo__11CrystalCageFRC12JMapInfoIter` | `0x801CBA20` | :white_check_mark: (100.0%) |
| `initModel__11CrystalCageFPCc` | `0x801CBB58` | :white_check_mark: (100.0%) |
...
| `exeBreak__11CrystalCageFv` | `0x801CBDBC` | :white_check_mark: (100.0%) |
...
| `clone__Q22MR49FunctorV0M<P11CrystalCage,M11CrystalCageFPCvPv_v>CFP7JKRHeap` | `0x801CC128` | :white_check_mark: (100.0%) |
| `__dt__11CrystalCageFv` | `0x801CC190` | :white_check_mark: (100.0%) |