...
| Name | Address | Match % |
|------|---------|---------|
| `__ct__4RockFfPCc` | `0x8021ADD8` | :white_check_mark: (100.0%) |
| `init__4RockFRC12JMapInfoIter` | `0x8021AEEC` | :x: (98.4%) |
| `appear__4RockFv` | `0x8021B0D4` | :white_check_mark: (100.0%) |
| `kill__4RockFv` | `0x8021B218` | :white_check_mark: (100.0%) |
| `getAppearFrame__4RockFv` | `0x8021B29C` | :white_check_mark: (100.0%) |
| `getType__4RockFRC12JMapInfoIter` | `0x8021B2A4` | :white_check_mark: (100.0%) |
| `getAppearStarPieceNum__4RockFQ24Rock4Type` | `0x8021B32C` | :white_check_mark: (100.0%) |
| `control__4RockFv` | `0x8021B340` | :white_check_mark: (100.0%) |
| `calcAndSetBaseMtx__4RockFv` | `0x8021B5BC` | :white_check_mark: (100.0%) |
| `attackSensor__4RockFP9HitSensorP9HitSensor` | `0x8021B78C` | :white_check_mark: (100.0%) |
| `receiveMsgPlayerAttack__4RockFUlP9HitSensorP9HitSensor` | `0x8021B950` | :white_check_mark: (100.0%) |
| `receiveMsgEnemyAttack__4RockFUlP9HitSensorP9HitSensor` | `0x8021BA54` | :white_check_mark: (100.0%) |
| `initMapToolInfo__4RockFRC12JMapInfoIter` | `0x8021BB4C` | :x: (99.8%) |
| `initModel__4RockFv` | `0x8021BC44` | :white_check_mark: (100.0%) |
| `initSensor__4RockFv` | `0x8021BDB8` | :x: (98.8%) |
| `initEffect__4RockFv` | `0x8021BF00` | :white_check_mark: (100.0%) |
| `isBreakByWall__4RockCFv` | `0x8021BF88` | :white_check_mark: (100.0%) |
| `move__4RockFf` | `0x8021BFFC` | :white_check_mark: (100.0%) |
| `calcBaseMtx__4RockCFPQ29JGeometry64TPosition3<Q29JGeometry38TMatrix34<Q29JGeometry13SMatrix34C<f>>>` | `0x8021C0A0` | :white_check_mark: (100.0%) |
...
| `startRollLevelSound__4RockFb` | `0x8021C2BC` | :white_check_mark: (100.0%) |
| `tryFreeze__4RockFPC5Nerve` | `0x8021C3CC` | :white_check_mark: (100.0%) |
| `setBtkForEnvironmentMap__4RockFP9LiveActorPCc` | `0x8021C448` | :white_check_mark: (100.0%) |
| `rumblePadAndCamera__4RockFv` | `0x8021C53C` | :white_check_mark: (100.0%) |
| `setNerveBreak__4RockFb` | `0x8021C5A4` | :white_check_mark: (100.0%) |
| `updateRotateX__4RockFf` | `0x8021C5F0` | :white_check_mark: (100.0%) |
| `appearStarPiece__4RockFv` | `0x8021C644` | :white_check_mark: (100.0%) |
| `moveOnRail__4RockFffb` | `0x8021C6CC` | :white_check_mark: (100.0%) |
| `isForceInvalidBindSection__4RockCFv` | `0x8021C7A0` | :white_check_mark: (100.0%) |
| `tryBreakReachedGoal__4RockFv` | `0x8021C814` | :white_check_mark: (100.0%) |
| `exeAppear__4RockFv` | `0x8021C884` | :x: (98.6%) |
| `exeAppearMoveInvalidBind__4RockFv` | `0x8021CAD4` | :white_check_mark: (100.0%) |
| `exeMove__4RockFv` | `0x8021CBB4` | :x: (99.8%) |
| `exeMoveInvalidBind__4RockFv` | `0x8021CED4` | :white_check_mark: (100.0%) |
| `exeBreak__4RockFv` | `0x8021CF68` | :x: (96.2%) |
| `exeFreeze__4RockFv` | `0x8021D28C` | :x: (91.4%) |
