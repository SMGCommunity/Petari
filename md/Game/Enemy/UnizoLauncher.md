# main/Game/Enemy/UnizoLauncher

**Source Path:** `src/Game/Enemy/UnizoLauncher.cpp`

## Functions

| Name | Address | Match % |
|------|---------|---------|
| `__ct__13UnizoLauncherFPCc` | `0x8014F86C` | :white_check_mark: (100.0%) |
| `init__13UnizoLauncherFRC12JMapInfoIter` | `0x8014F8A8` | :x: (0.0%) |
| `exeLaunch__13UnizoLauncherFv` | `0x8014FA00` | :x: (0.0%) |
| `__dt__13UnizoLauncherFv` | `0x8014FAD0` | :white_check_mark: (100.0%) |
