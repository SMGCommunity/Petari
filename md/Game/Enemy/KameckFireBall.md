# main/Game/Enemy/KameckFireBall

**Source Path:** `src/Game/Enemy/KameckFireBall.cpp`

## Functions

| Name | Address | Match % |
|------|---------|---------|
| `__ct__14KameckFireBallFPCc` | `0x801074F8` | :white_check_mark: (100.0%) |
| `init__14KameckFireBallFRC12JMapInfoIter` | `0x80107554` | :white_check_mark: (100.0%) |
...
| `__dt__14KameckFireBallFv` | `0x80107BF0` | :white_check_mark: (100.0%) |
| `__sinit_\KameckFireBall_cpp` | `0x80107C4C` | :white_check_mark: (100.0%) |
| `execute__Q221NrvBossKameckBeamFire22KameckFireBallNrvSweepCFP5Spine` | `0x80107C90` | :white_check_mark: (100.0%) |
| `execute__Q221NrvBossKameckBeamFire21KameckFireBallNrvWaitCFP5Spine` | `0x80107C98` | :white_check_mark: (100.0%) |
| `__ct__Q221NrvBossKameckBeamFire21KameckFireBallNrvWaitFv` | `0x80107CA0` | :white_check_mark: (100.0%) |
| `__ct__Q221NrvBossKameckBeamFire22KameckFireBallNrvSweepFv` | `0x80107CB0` | :white_check_mark: (100.0%) |