# main/Game/Speaker/SpkSpeakerCtrl
...
| `setup__14SpkSpeakerCtrlFv` | `0x80393DCC` | :white_check_mark: (100.0%) |
| `connect__14SpkSpeakerCtrlFl` | `0x80393EC0` | :white_check_mark: (100.0%) |
| `disconnect__14SpkSpeakerCtrlFl` | `0x80393F40` | :white_check_mark: (100.0%) |
...
| `startPlayCallback__14SpkSpeakerCtrlFll` | `0x8039416C` | :white_check_mark: (100.0%) |
...
| `reconnectProcess__14SpkSpeakerCtrlFl` | `0x803942FC` | :white_check_mark: (100.0%) |
...
| `isEnable__14SpkSpeakerCtrlFl` | `0x80394534` | :white_check_mark: (100.0%) |
...
| `__sinit_\SpkSpeakerCtrl_cpp` | `0x80394618` | :white_check_mark: (100.0%) |
| `__arraydtor$3716` | `0x80394670` | :white_check_mark: (100.0%) |