...
| Name | Address | Match % |
|------|---------|---------|
| `getValue<l>__12JMapInfoIterCFPCcPl_b` | `0x800178C8` | :white_check_mark: (100.0%) |
| `__ct__7BckCtrlFP14ResourceHolderPCc` | `0x8001792C` | :white_check_mark: (100.0%) |
...
| `__ct__11BckCtrlDataFv` | `0x80018020` | :white_check_mark: (100.0%) |