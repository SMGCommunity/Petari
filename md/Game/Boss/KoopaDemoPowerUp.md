# main/Game/Boss/KoopaDemoPowerUp

**Source Path:** `src/Game/Boss/KoopaDemoPowerUp.cpp`

## Functions

| Name | Address | Match % |
|------|---------|---------|
| `__dt__16KoopaDemoPowerUpFv` | `0x8005C504` | :white_check_mark: (100.0%) |
| `__ct__16KoopaDemoPowerUpFP5Koopa` | `0x8005C55C` | :white_check_mark: (100.0%) |
...
| `execute__Q219NrvKoopaDemoPowerUp23KoopaDemoPowerUpNrvDemoCFP5Spine` | `0x8005C980` | :white_check_mark: (100.0%) |
| `execute__Q219NrvKoopaDemoPowerUp27KoopaDemoPowerUpNrvWaitDemoCFP5Spine` | `0x8005C988` | :white_check_mark: (100.0%) |