# main/JSystem/JKernel/JKRThread
...
| `enter__15JKRThreadSwitchFP9JKRThreadi` | `0x8040E844` | :x: (98.3%) |
| `__as__Q28JUtility6TColorFRCQ28JUtility6TColor` | `0x8040E8B8` | :x: (0.0%) |
| `__sinit_\JKRThread_cpp` | `0x8040E8DC` | :x: (99.9%) |
...
| `__ct__19JSUList<9JKRThread>Fb` | `0x8040EA08` | :white_check_mark: (100.0%) |
| `__dt__19JSUList<9JKRThread>Fv` | `0x8040EA38` | :white_check_mark: (100.0%) |
| `__ct__17JSUList<7JKRTask>Fv` | `0x8040EA90` | :white_check_mark: (100.0%) |
