# main/RVL_SDK/vf/pf_volume

**Source Path:** `src/RVL_SDK/vf/pf_volume.c`

## Functions

| Name | Address | Match % |
|------|---------|---------|
| `VFiPFVOL_DoMountVolume` | `0x80482204` | :white_check_mark: (100.0%) |
| `VFiPFVOL_p_unmount` | `0x80482318` | :x: (93.8%) |
| `VFiPFVOL_InitModule` | `0x8048241C` | :x: (70.6%) |
...
| `VFiPFVOL_errnum` | `0x80482E2C` | :white_check_mark: (100.0%) |
