...
| Name | Address | Match % |
|------|---------|---------|
| `parse_format` | `0x80521E84` | :white_check_mark: (100.0%) |
| `long2str` | `0x80522444` | :white_check_mark: (100.0%) |
| `longlong2str` | `0x80522678` | :white_check_mark: (100.0%) |
| `double2hex` | `0x80522924` | :white_check_mark: (100.0%) |
| `round_decimal` | `0x80522CEC` | :white_check_mark: (100.0%) |
| `float2str` | `0x80522E14` | :white_check_mark: (100.0%) |
| `__wpformatter` | `0x805235B4` | :white_check_mark: (100.0%) |
