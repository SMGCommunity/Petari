...
static OSInterruptMask InterruptPrioTable[] = {0x100, 0x40, 0xF8000000, 0x200, 0x80, 0x10, 0x3000, 0x20, 0x3FF8C00, 0x4000000, 0x4000, 0xFFFFFFFF};
...
BOOL OSRestoreInterrupts(register BOOL level) NO_INLINE {
    asm {
        cmpwi level, 0
        mfmsr r4
        beq disable
