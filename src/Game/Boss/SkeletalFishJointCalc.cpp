...
void SkeletalFishJointCalc::calcJoint(TPos3f* pDst, const TPos3f* pSrc, SkeletalFishRailControl* pRailCtrl, const JointControllerInfo&) {
    ...
    TPos3f offsetMtx;
    offsetMtx.makeTrans(0.0f, 0.0f, -trans.z);
