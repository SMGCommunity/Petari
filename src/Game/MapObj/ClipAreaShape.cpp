...
bool ClipAreaShape::isInArea(const TVec3f &a1, f32 a2, const TPos3f &a3,
                             const TVec3f &a4) const {
  if (MR::isNearZero(a4.x, 0.001f) ||
      (MR::isNearZero(a4.y, 0.001f) || MR::isNearZero(a4.z, 0.001f))) {
    return false;
  }
...
void ClipAreaShape::calcVolumeMatrix(TPos3f *pVolMtx, const TPos3f &rSrcMtx,
...
bool ClipAreaShape::isInArea(const TVec3f &) const { return false; }
