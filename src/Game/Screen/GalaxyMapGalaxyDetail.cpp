...
void GalaxyMapGalaxyDetail::init(const JMapInfoIter& rIter) {
    ...
    initNerve(GET_NERVE_ANON(GalaxyMapGalaxyDetailAppear));
    kill();
}
...
void GalaxyMapGalaxyDetail::appear() {
    ...
    setNerve(GET_NERVE_ANON(GalaxyMapGalaxyDetailAppear));
}
...
void GalaxyMapGalaxyDetail::exeAppear() {
    ...
    MR::setNerveAtAnimStopped(this, GET_NERVE_ANON(GalaxyMapGalaxyDetailDisplay), 0);
}
...
void GalaxyMapGalaxyDetail::exeDisplay() {
    ...
    if (MR::testCorePadTriggerA(WPAD_CHAN0)) {
        setNerve(GET_NERVE_ANON(GalaxyMapGalaxyDetailDisappear));
    }
}
