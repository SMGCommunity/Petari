...
void JPASetRMtxfromMtx(f32 const (*param_0)[4], f32 (*param_1)[4]) {
    JGeometry::TVec3< f32 > dummy_0;
    JGeometry::TVec3< f32 > dummy_1;
    JPASetRMtxSTVecfromMtx(param_0, param_1, &dummy_0, &dummy_1);
}
