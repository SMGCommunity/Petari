...
namespace {
    ...
    const NameObjFactory::Name2CreateFunc cCreateTable[1183] = {
		...
		{ "RestartCube", createBaseOriginCube<RestartCube>, 0 },
		{ "WarpCube", createBaseOriginCube<WarpCube>, 0 },
		...
		{ "BloomCube", createCenterOriginCube<BloomArea>, 0 },
		{ "BloomSphere", createSphere<BloomArea>, 0 },
		{ "BloomCylinder", createBaseOriginCylinder<BloomArea>, 0 },
		...
		{ "CocoNut", createNameObj<CocoNut>, 0 },
		...
		{ "BlueChipGroup", createNameObj<BlueChipGroup>, 0 },
		{ "YellowChipGroup", createNameObj<YellowChipGroup>, 0 },
		...
		{ "ClipFieldSwitch", createNameObj<ClipFieldSwitch>, 0 },
