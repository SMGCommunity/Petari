...
namespace {
    ...
    const NameObjFactory::Name2CreateFunc cCreateTable[1183] = {
		...
		{ "HomeAir", NULL, "HomeAir" },
		{ "SphereAir", NULL, "SphereAir" },
		{ "SunsetAir", NULL, "SunsetAir" },
		{ "FineAir", NULL, "FineAir" },
		{ "DimensionAir", NULL, "DimensionAir" },
		{ "DarknessRoomAir", NULL, "DarknessRoomAir" },
		{ "TwilightAir", NULL, "TwilightAir" },
		{ "ZoneHalo", NULL, "ZoneHalo" },
		{ "PowerStarHalo", NULL, "PowerStarHalo" },
