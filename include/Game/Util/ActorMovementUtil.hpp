...
namespace MR {
    ...
    void calcGravitySpeed(const LiveActor *);
    ...
    void turnDirectionFromTargetDegree(const LiveActor *, TVec3f *, const TVec3f &, f32);
    void turnDirectionFromTargetDegreeHorizon(const LiveActor *, TVec3f *, const TVec3f &, f32);
