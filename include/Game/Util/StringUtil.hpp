...
namespace MR {
    ...
    wchar_t* addNumberFontTag(wchar_t*, int);
    char* removeExtensionString(char*, u32, const char*);
    ...
    wchar_t* addPictureFontTag(wchar_t*, int);
    wchar_t* addPictureFontTagPlayerIcon(wchar_t*);
    wchar_t* addNewLine(wchar_t*);
    wchar_t* addNumberFontTag(wchar_t*, const wchar_t*, ...);
