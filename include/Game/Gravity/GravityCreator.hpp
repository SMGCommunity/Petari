...
public:
    inline CubeGravityCreator()
        : GravityCreator(), mGravityInstance(nullptr) {}
...
public:
    inline DiskTorusGravityCreator()
        : GravityCreator(), mGravityInstance(nullptr) {}
...
public:
    inline PlaneInBoxGravityCreator()
        : GravityCreator(), mGravityInstance(nullptr) {}
...
public:
    inline PlaneInCylinderGravityCreator()
        : GravityCreator(), mGravityInstance(nullptr) {}
...
public:
    inline WireGravityCreator()
        : GravityCreator(), mRailRider(nullptr), mGravityInstance(nullptr) {}
