...
public:
    ...
    /* 0x08 */ virtual ~CameraShakePattern() {
    }

    /* 0x0C */ virtual bool isEnd() const = 0;
    /* 0x10 */ virtual void getOffset(TVec2f*) const = 0;
    /* 0x14 */ virtual void start() = 0;
...
public:
    ...
    /* 0x0C */ virtual bool isEnd() const;
    /* 0x10 */ virtual void getOffset(TVec2f*) const;
