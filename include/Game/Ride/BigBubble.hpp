...
namespace NrvBigBubble {
    NERVE(BigBubbleNrvAppear);
    NERVE(BigBubbleNrvWait);
    NERVE_EXECEND(BigBubbleNrvCapture);
    NERVE(BigBubbleNrvBreak);
    NERVE(BigBubbleNrvEscape);
    NERVE(BigBubbleNrvGoal);
    NERVE(BigBubbleNrvMerged);
}
