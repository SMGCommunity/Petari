...
namespace JGadget {
    ...
    class TLinkListNode {
    public:
        INLINE_FUNC_DECL_NO_ARG(TLinkListNode)
    ...
    public:
        struct iterator {
            ...
            INLINE_FUNC_DECL(iterator, TLinkListNode* node)
                : curr(node) {}
        ...
        INLINE_FUNC_DECL_NO_ARG(TNodeLinkList)
            : CALL_INLINE_FUNC_NO_ARG(mEnd) {
            Initialize_();
        }
    ...
    public:
        struct iterator : public TIterator<std::bidirectional_iterator_tag, T>,
            ...
            iterator(TLinkListNode* iter)
                : CALL_INLINE_FUNC(TNodeLinkList::iterator, iter) {}
