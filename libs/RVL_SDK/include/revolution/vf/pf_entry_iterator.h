...
static s32 VFiPFENT_ITER_MoveTo(PF_ENT_ITER* p_iter, u32 index, u32 may_allocate);
...
static s32 VFiPFENT_ITER_LoadEntry(PF_ENT_ITER* p_iter);
s32 VFiPFENT_ITER_FindEntry(PF_ENT_ITER* p_iter, PF_DIR_ENT* p_ent, PF_STR* p_pattern, u8 attr_required, u32* p_is_found, u32* p_ppos, u32* p_lpos,
                            u32 is_skip);
