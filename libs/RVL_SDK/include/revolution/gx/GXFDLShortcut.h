...
#define SC_XF_MATERIAL0_F_SET_RGB(xf_material0_f, rgb) \
    FAST_GPFLAGSET(xf_material0_f, rgb, XF_MATERIAL0_F_RGB)
...
#define SC_XF_MATERIAL1_F_SET_RGB(xf_material1_f, rgb) \
    FAST_GPFLAGSET(xf_material1_f, rgb, XF_MATERIAL1_F_RGB)
...
#define SC_XF_COLOR0CNTRL_F_SET_LIGHT0123(xf_color0cntrl_f, light0123) \
    FAST_GPFLAGSET(xf_color0cntrl_f, light0123, XF_COLOR0CNTRL_F_LIGHT0123)
...
#define SC_XF_COLOR0CNTRL_F_SET_LIGHT4567(xf_color0cntrl_f, light4567) \
    FAST_GPFLAGSET(xf_color0cntrl_f, light4567, XF_COLOR0CNTRL_F_LIGHT4567)
