...
#define SC_XF_AMBIENT0_F_SET_RGB(xf_ambient0_f, rgb) \
    FAST_GPFLAGSET(xf_ambient0_f, rgb, XF_AMBIENT0_F_RGB)
...
#define SC_XF_AMBIENT1_F_SET_RGB(xf_ambient1_f, rgb) \
    FAST_GPFLAGSET(xf_ambient1_f, rgb, XF_AMBIENT1_F_RGB)
